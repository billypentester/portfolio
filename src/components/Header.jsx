...
const details = {
    ...
    description: 'I\'m a passionate software developer who loves to build and break things. I\'m also a security enthusiast who loves to learn and share knowledge.'
}
...
export default function Header () {
    return (
        <header className={inter.className}>
            ...
            <div className="w-1/2">
                <h1 className="text-4xl text-neutral font-medium mb-3">Hello,</h1>
                <h1 className="text-6xl text-neutral font-medium">I&apos;m <span className="text-secondary font-semibold">{details.name}</span></h1>
                <h2 className="text-3xl text-neutral font-medium my-5">{details.role}</h2>
                <p className="text-xl text-neutral my-5">{details.description}</p>
